...
import { useDispatch } from 'react-redux'; // Import du hook useDispatch
import { addItem } from './CartSlice'; // Import de l'action addItem depuis CartSlice
...
function ProductList({ onHomeClick }) {
    ...
    // Fonction d'ajout au panier modifiée avec Redux Action et mise à jour locale
    const handleAddToCart = (product) => {
        dispatch(addItem(product)); // Envoie le produit à Redux

        setAddedToCart((prevState) => ({
            ...prevState,
            [product.name]: true, // Marque le produit comme ajouté localement
        }));
    };
